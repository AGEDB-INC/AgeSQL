...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MATCH = 17,                     /* MATCH  */
  YYSYMBOL_WHERE = 18,                     /* WHERE  */
  YYSYMBOL_WITH = 19,                      /* WITH  */
  YYSYMBOL_ORDER = 20,                     /* ORDER  */
  YYSYMBOL_BY = 21,                        /* BY  */
  YYSYMBOL_SKIP = 22,                      /* SKIP  */
  YYSYMBOL_LIMIT = 23,                     /* LIMIT  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ASC", "ARROW", "AS",
  "DESC", "LBRACKET", "RBRACKET", "LPAREN", "RPAREN", "COLON", "PIPE",
  "COMMA", "SEMICOLON", "LBRACE", "RBRACE", "MATCH", "WHERE", "WITH",
  "ORDER", "BY", "SKIP", "LIMIT", "RETURN", "INTEGER", "IDENTIFIER",
  "STRING", "UNKNOWN", "$accept", "statement", YY_NULLPTR
};
...
#line 47 "cypher.y"
    { /* no action needed */ }
#line 1108 "cypher.tab.c"
    break;


#line 1112 "cypher.tab.c"
